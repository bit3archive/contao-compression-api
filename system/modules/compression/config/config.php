...
$GLOBALS['TL_JS_MINIMIZER']  = (isset($GLOBALS['TL_JS_MINIMIZER']) && is_array($GLOBALS['TL_JS_MINIMIZER']) ? $GLOBALS['TL_JS_MINIMIZER'] : array());
$GLOBALS['TL_CSS_MINIMIZER'] = (isset($GLOBALS['TL_CSS_MINIMIZER']) && is_array($GLOBALS['TL_CSS_MINIMIZER']) ? $GLOBALS['TL_CSS_MINIMIZER'] : array());
